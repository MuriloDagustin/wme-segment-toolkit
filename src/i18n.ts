...
const EN: Messages = {
    ...
    speedSuffix: 'km/h',
    badgeTitle: 'Visible segments matching this rule. Click to jump to the closest one.',
...
const PT: Messages = {
    ...
    speedSuffix: 'km/h',
    badgeTitle: 'Segmentos visíveis que casam esta regra. Clique para ir ao mais próximo.',
