...
export async function buildPanel(app: App): Promise<void> {
    ...
    appendDescription(tabPane, app.messages.panelDescription);
    ...
    appendCountrySelector(tabPane, app, () => {
        renderRules(rulesContainer, totalEl, app);
        app.refresh();
    });
    appendDebugSwitch(tabPane, app);
    ...
    appendSelectStreetButton(tabPane, app);
    appendActionButtons(tabPane, rulesContainer, totalEl, app);
}
...
function appendSelectStreetButton(parent: HTMLElement, app: App): void {
